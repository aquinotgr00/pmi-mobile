exports.mixed = {
  ...
  exports.object = {
    noUnknown: 'bidang ${path} tidak boleh berisi kunci yang tidak ditentukan'
  };
  
  exports.array = {
    min: 'bidang ${path} harus mengandung setidaknya ${min} item',
    max: 'bidang ${path} harus mengandung paling banyak ${max} item'
  };
